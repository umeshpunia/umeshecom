...
const CourseSchema = require("../models/single-course.model");
const multer = require("multer");
const fs = require("fs");

const router = express.Router();

const coursePicPath = "assets/images/single";
...
router.post("/add", (req, res) => {
  upload(req, res, function (err) {
    const { name, addedBy, description,price,course } = req.body;
    ...
    let insCourse = new CourseSchema({ name, addedBy, description,price,course,picture });
